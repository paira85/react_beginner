...
export const CLASS_CATEGORY = [
    ...
    {id: 6, label: '마케팅',category: 'planmarketingning', icon: <ChartNoAxesCombined />},
    {id: 7, label: '디자인.일러스트',category: 'design', icon: <DraftingCompass />},
    {id: 8, label: '자기 계발',category: 'self-development', icon: <Footprints />},
...
export const TOPIC_CATEGORY = [
    ...
    {id: 5, label: '마케팅',category: 'planmarketingning'},
    {id: 6, label: '디자인.일러스트',category: 'design'},
    {id: 7, label: '자기 계발',category: 'self-development'},
